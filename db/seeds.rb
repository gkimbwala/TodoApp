...
Todo.create!(title: 'Best Orchestra Ever', notes:'The Metropole Orkest is the best in the workd!')
Todo.create!(title: 'Best Dad Ever', notes: 'The award defintely goes to Papa Henry') 
